...
const ScrollingText = () => {
  return (
    <div className="overflow-hidden whitespace-nowrap bg-black border-t border-b text-white transform rotate-[-3deg] p-3 sm:p-5 mb-6 sm:mb-12 mt-5 sm:mt-7">
      <div className="w-full">
        <div className="animate-scroll text-base sm:text-3xl md:text-4xl lg:text-5xl xl:text-7xl py-2 font-barlow font-bold">
